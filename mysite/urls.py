...
urlpatterns = [
    ...
    path('match_all_check_worksheet/<int:worksheet_number>/<int:check_number>/<int:barcode_count>/', MatchAllCheckWorksheetView.as_view(), name='MatchAllCheckWorksheetView'),
]
