...
#     the extra parameter to create the required number for BarcodeCheckForm forms. self.kwargs['barcode_count'] is passed in
...
#         print(self.request.POST['form-0-barcode'])
#         print(form)
#         form.save()
